...
//        ↓userEditInput.getName()が空文字列だったらTrue
    ...
    public List<User> getUserByName(String searchWords) {
        return this.userMapper.getUserByName(searchWords);
    }

    public List<User> getUserByRole(String searchWords) {
        return this.userMapper.getUserByRole(searchWords);
    }

    public List<User> getUserByCode(int searchWords) {
        return this.userMapper.getUserByCode(searchWords);
    }
